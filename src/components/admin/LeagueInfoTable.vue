        ...
        <b-form-row align-h="center">
          <b-col cols="6">
            <b-form-group
              ...
              label="Created On:"
            >
              <b-form-input id="createdDate" type="text" v-model="league.CreatedDate"></b-form-input>
            </b-form-group>
          </b-col>
          <b-col cols="6">
            <b-form-group
        ...
        <b-form-row align-h="center">
          <b-col cols="6">
            <b-form-group
              ...
              label="Created By:"
            >
              <b-form-input id="createdBy" type="text" v-model="league.CreatedByUserID"></b-form-input>
            </b-form-group>
          </b-col>
...
export default {
  ...
  mounted() {
    axios
      .get("/api/fantasyleagues/" + this.league.FantasyLeagueID + "/")
      .then(response => {
  ...
  methods: {
    onSubmit(event) {
      ...
      fetch("/api/fantasyleagues/" + this.league.LeagueID, {
        ...
        body: JSON.stringify(this.league) // body data type must match "Content-Type" header
      })
        .then(response => {
          this.successCount = 5;
          this.errorCount = 0;
